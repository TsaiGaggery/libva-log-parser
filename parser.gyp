...
def main(argv):
    ...
    with open (outputfile, 'w', newline='') as f_save:
        ...
        fieldnames = ['timeline', 'FPS', 'Average resolution']
                        ...
                        if len(x) == 3:
                            ...
                            if "frame_width" in data:  
                                ...
                                if previous_timeline != current_timeline:
                                    ...
                                    csv_writer.writerow({"timeline": current_timeline, "FPS" : fps_counter, "Average resolution" : acc_frame_width/fps_counter})
